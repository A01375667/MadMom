...
public class PantallaAjustes extends Pantalla
{
    ...
    private mx.itesm.madmom.Objeto mama;
    private mx.itesm.madmom.Objeto objetoTextoSonido;
    ...
    // Constructor
    public PantallaAjustes(mx.itesm.madmom.MadMom madMom){
        this.madMom = madMom;
    ...
    private void crearObjetos() {
        ...
        mama = new mx.itesm.madmom.Objeto(texturaMama, ANCHO/5, ALTO/2 - texturaMama.getHeight()/2);

        objetoTextoSonido = new mx.itesm.madmom.Objeto(texturaTextoSonido, ANCHO/2 + texturaTextoSonido.getWidth()/8, ALTO/2 - texturaTextoSonido.getHeight()/2);
        ...
        btnBack.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                if (madMom.estadoMusica.equals(mx.itesm.madmom.EstadoMusica.PLAY))
                    efectoBoton.play();
                madMom.setScreen(new mx.itesm.madmom.PantallaCargando(madMom, mx.itesm.madmom.Pantallas.CONFIGURACION, mx.itesm.madmom.Pantallas.TipoPantalla.MENU));
            }
        });
